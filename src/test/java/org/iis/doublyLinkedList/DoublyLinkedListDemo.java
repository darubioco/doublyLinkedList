...
public class DoublyLinkedListDemo {
    ...
    public static void main(String[] args) {
        ...
        list2.set(2, 'x');
        System.out.println("List2 (element at index 2 changed to 'x'): " + list2);
        list2.removeNodeAtIndex(1);
        System.out.println("List2 (removed node at index 1): " + list2);
        
        System.out.println("\nArray from list: " + Arrays.toString(list.toArray()));
        list.add(2);
        list.add(2);
        list.addFirst(2);
        System.out.println("List (added element 2 twice, and added 2 in first place): " + list);
        ...
        System.out.println("List (removed first and last occurrences of 2): " + list);
        System.out.println("Sublist (index 0 to 2) from list: " + list.sublist(0, 2));
